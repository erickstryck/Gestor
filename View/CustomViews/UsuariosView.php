	...
	public function novoUsuarioView(){
		...
		while($associativa->fetch()){
			...
			while( $usuario->fetch()){
				...
				parent::$templator->setVariable('usuario.acesso', ( $associativa->temAcesso ) ? "Sim" : "<b style='color:red'>Não</b>");
				parent::$templator->setVariable('usuario.vendedor', ( $associativa->isVendedor ) ? "Sim" : "<b style='color:red'>Não</b>");
				parent::$templator->setVariable('usuario.tecnico', ( $associativa->isTecnico ) ? "Sim" : "<b style='color:red'>Não</b>");
