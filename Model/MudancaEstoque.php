...
class MudancaEstoque extends Lumine_Base {
    ...
    protected function _initialize()
    {
        ...
        $this->metadata()->addField('tipoAjusteId', 'tipo_ajuste_id', 'int', 11, array('primary' => true, 'notnull' => true, 'foreign' => '1', 'onUpdate' => 'RESTRICT', 'onDelete' => 'RESTRICT', 'linkOn' => 'id', 'class' => 'TipoAjuste'));
