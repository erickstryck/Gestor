...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.date').mask('9999-99-99').width(80).datepicker({
                dateFormat: 'yy-mm-dd',
                showOn: 'button',
                buttonImage: 'calendar.png',
                buttonImageOnly: true
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" id="jumpmenu"
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" enctype="multipart/form-data" id="busca">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="2" class="tableWhite">
        ...
        <tr>
            <th width="3%">&nbsp;</th>
            <th width="3%"><a href="javascript:" onclick="$('#busca').submit();"><img src="magnifier.png" width="16"
                                                                                      height="16" alt="Pesquisar"
                                                                                      title="Pesquisar"/></a></th>
            <?php
            foreach ($parts as $name => $item) {
                $item['name'] = $name;
                if (empty($item['options']['foreign'])) {
        ...
        while ($obj->fetch()):
            ...
            ?>
            <tr>
                <td><a href="?_lumineAction=edit&amp;<?php echo $pks_string; ?>"><img src="page_edit.png" width="16"
                                                                                      height="16" alt="Editar"
                                                                                      title="Editar"/></a></td>
                <td><a href="?_lumineAction=delete&amp;<?php echo $pks_string; ?>"><img src="page_delete.png" width="16"
                                                                                        height="16" alt="Remover"
                                                                                        title="Remover"/></a></td>
                <?php
                foreach ($parts as $name => $item) {
                    echo '<td>',
