    ...
    CalendarioInput.prototype = {
        ...
        bindTimeout: function () {
            if (this.intervalo == null) {
                ...
                $(this.button).onmouseover = CalendarioEventos.delegate(this, function () {
                    clearTimeout(this.intervalo);
                });
...
<form id="frmLumine" name="frmLumine" method="post" action="<?php echo $action; ?>">
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#C4F3FF">
        ...
        foreach ($def as $name => $prop) {
            ...
            <tr>
                <td width="49%" align="right" valign="top"
                    bgcolor="#FFFFFF"><?php if (!empty($prop['options']['notnull'])) echo '* '; ?>
                    <?php echo $prop['options']['label']; ?>:
                </td>
        ...
        ?>
        <tr>
            <td colspan="2" align="center" bgcolor="#FFFFFF"><input type="button" name="btInserir" value="Inserir"
                                                                    id="btInserir" onclick="inserir()"/>
