    ...
    <table cellpadding="2" cellspacing="1" border="0" bgcolor="#CCCCCC" width="100%">
        <tr>
            ...
            foreach ($def as $name => $item) {
                ?>
                <td bgcolor="#FFFFFF"><input type="text" name="<?php echo $name ?>_filter_"
                                             value="<?php echo @$_GET[$name . '_filter_'] ?>"
                                             onblur="$('busca').submit()"/></td>
                <?php
            }
            ?>
        </tr>
        ...
        if (!empty($list)) {
            ...
            ?>
            <tr>
                <td colspan="<?php echo count($def) + 1; ?>" bgcolor="#FFFFFF">N&atilde;o h&aacute; registros</td>
            </tr>
            <?php
        }
        ?>
